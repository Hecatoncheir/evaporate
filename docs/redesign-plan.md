...
> **Пересмотрен 2026-09-25** записью `docs/decisions/0013-prototype-ui-as-is.md`: интерфейс — код прототипа «как есть», связанный с блоками приложения. Сделанное по этому плану (Ф1–Ф7) остаётся в истории ветки `redesign`, дальнейший порядок — `docs/port-plan.md`.
