...
const _lines = [
  ...
  'lib/ui/library/saves/rule_dialog.dart: _RuleDialogState.build: 84',
  'lib/ui/library/saves/rule_tile.dart: RuleTile.build: 72',
  'lib/ui/saves/bulk_transfer_card.dart: _BulkReportView.build: 68',
  ...
  'lib/ui/settings/log_card.dart: _LogCardState.build: 70',
