...
/// (`docs/decisions/0013-prototype-ui-as-is.md`). Стражи оформления и
/// устройства виджетов его не читают, пока он не приведён к правилам
/// проекта: иначе каждая правка под данные и события начиналась бы с
/// переписывания файла целиком. Слои, анализатор, блоки и тесты — как
/// везде, а непереведённые строки держит храповик по файлам.
