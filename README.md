...
Их не более 640; отдельный рисуемый слой не перестраивает сетку на кадрах.
Карточки деформируются через [Dough](https://github.com/josiahsrc/dough),
а общий контур выделения перетекает между ними с волнистой границей и
сужающейся перемычкой. Это геометрическая деформация, без полноэкранного
