...
«Живая библиотека» в настройках включает магнитные частицы и голографический
...
Обычная рамка фокуса сохранена, жидкой деформации и перетекающей подложки нет.
...
Частицы притягиваются к курсору и обращаются вдоль границ карточки:
возле цели растут плотность, яркость и хаотичность, но не радиус частиц.
Вдали точки хаотично двигаются и имеют цвет `#2f0346` на светлом фоне и
`#e6dbc7` на тёмном. Возле цели в обеих темах одна насыщенная цветная палитра.
Свечение вокруг точек отключено; 1200 фоновых точек остаются видимыми
и при отключённом движении. Всего частиц не более 3200; отдельный рисуемый
...
Чем ближе частицы к цели, тем плотнее они собираются: притяжение усиливается,
а разлёт поперёк границы подавляется. Быстрое хаотическое движение вдоль
границ сохраняется; предел скорости — 360 пикселей/с. Радиус точек не меняется.
Вдали движение остаётся прежним. В библиотеке и на странице игры используется
один wave-фон из 26 линий, по [референсу #wave](https://hecatoncheir.github.io/).
Золотисто-пурпурный фон кнопки «Играть» рисует пакет
[bokeh_lava_gradient](https://pub.dev/packages/bokeh_lava_gradient):
10 мягких цветных пятен, 30 кадров/с, с контрастной подложкой под подписью.
