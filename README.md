...
проверит подпись релиза и контрольную сумму и заменит установку. Подпись —
Ed25519 под файлом `SHA256SUMS`, закрытый ключ есть только у проекта; релиз
без подписи или с чужой приложение не ставит. Пакет `.deb` — исключение, и
