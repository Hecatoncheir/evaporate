...
Пять блоков держат приложение — `SettingsBloc`, `LibraryBloc`,
`SavesBloc`, `DownloadsBloc`, `NavigationBloc`, — и ещё девять живут при
своих экранах и диалогах: поиск установленных игр, добавление игры,
журнал, форма правила, форма прокси, обновление, история скоростей,
предпросмотр восстановления, запрос и полка библиотеки. Событий около
