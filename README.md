...
[`release_artifacts_test.dart`](test/release_artifacts_test.dart)
...
Три шрифта, все вшиты в сборку, а не подтягиваются из сети: Golos Text на
интерфейс, Unbounded на заголовки и главные клавиши, JetBrains Mono на пути,
размеры и показания. Все три рисовали с кириллицей, а не добавляли её позже;
начертания вариативные — один файл на семейство. Новая иконка создана imagegen:
