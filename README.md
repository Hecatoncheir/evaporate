...
- **Библиотека** — сетка вертикальных обложек, как в Steam: полки «Все»,
  «Установленные» и «Не установленные», обложка тянется из Steam по
  идентификатору игры, статусы, наигранное время, дата последнего запуска.
...
чужая работа со своими условиями — Ludusavi под MIT и три шрифта под OFL;
