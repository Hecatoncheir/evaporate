...
(папки ещё нет) и `SyncFolderContents` (что в ней лежит). Осталась
`Game.copyWith` — см. этап 6: там двадцать семь полей, и короче она
станет только вместе с разбором модели.
