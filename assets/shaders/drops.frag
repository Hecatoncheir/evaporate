// Капли, стекающие по стеклу: поле смещения искажает то, что под ним, —
// поэтому шейдеру нужна сама картинка, а не только время.
//
// Взят из flutter_shady_weather_demo и оставлен почти как есть: переписывать
// чужую математику ради своего почерка — не улучшение, а риск. Условия
// автора ниже сохранены дословно.
//
