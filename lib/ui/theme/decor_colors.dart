...
///
/// Набор собран вокруг ночной схемы: раскалённый оранжевый, циан, коралл,
/// янтарь и фиолетовая дуга — те же голоса, что и у корпуса, только в
/// полную силу. Начинается кольцо не с янтаря: он же основной цвет
/// частицы ночью, и свечение на первом шаге кольца ничего бы не меняло.
///
/// Кольцо одно на обе схемы: светящаяся частица, перелив фольги и
/// перламутр под сеткой днём берут те же цвета, что ночью.
