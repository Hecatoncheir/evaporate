...
/// не квадратом, и ни одна клавиша каркаса под полосу не попадает: верхняя
/// полоса каркаса стоит у самого края окна, но её клавиши, как и рейл,
/// отступают от края дальше, чем [edge]. Держит это тест «полосы у края
/// не накрывают ни одной клавиши» — в обычной, увеличенной и узкой
/// раскладке.
class WindowChrome {
