...
/// Надпись на крупном кадре: метка, название, чипы и клавиши.
///
...
/// строки его место в 238 точках заняли чипы, а живёт оно на странице
/// игры. Когда главная клавиша погашена, на месте чипов стоит причина:
...
///
/// Одной строкой: второй ряд чипов вытолкнул бы клавиши из кадра, поэтому
