...
/// он маленьким — [blurredDecodeWidth] точек: при таком размытии деталей
/// крупнее не видно, а полный файл выбранной человеком обложки весил бы в
/// памяти десятки мегабайт. Расшифровка одна на открытие страницы, а не на
/// каждую перелистку, — это и разводит фон с окружением (`AmbientLight`),
/// которое считает цвет от названия, а не от пикселей.
