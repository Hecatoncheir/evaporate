/// Разделы приложения — в порядке рейла сверху.
///
/// Перечислением, а не числами: прежде их было двое — счёт `sectionCount`
/// в блоке и два параллельных списка подписей и значков на рейле, — да ещё
/// `_downloadsSection = 1` рядом с ними. Расходятся такие списки молча:
/// пятый раздел появился бы на рейле, но не в счёте, и клавиша вела бы
/// в пустоту.
enum AppSection {
  library,
  downloads,
  ...
  /// Соседний раздел по кругу: рейл листается и вправо, и влево.
