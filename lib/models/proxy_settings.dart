...
class ProxySettings extends Equatable {
  ...
  /// Идут ли через прокси запросы к каталогам — Steam и базе путей
  /// сохранений.
  ///
  /// Флаг один на оба, и спрашивают его в двух местах: «качать через
  /// прокси, а в Steam ходить напрямую» — законное желание, ради него
  /// флаг и заведён. Правило лежит здесь, чтобы два места не разошлись.
  bool get forCatalogs => isUsable && useForSteam;
